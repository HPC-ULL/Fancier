...
public class ARGBColor {
  ...
  public static int toArgb(Byte4 color) {
    return ((color.x & 0xff) << 24) | ((color.y & 0xff) << 16) | ((color.z & 0xff) << 8)
        | ((color.w & 0xff) << 0);
  }

  public static Byte4 fromArgb(int argb) {
    return new Byte4((byte) ((argb >> 24) & 0xff), (byte) ((argb >> 16) & 0xff),
        (byte) ((argb >> 8) & 0xff), (byte) ((argb >> 0) & 0xff));
  }
