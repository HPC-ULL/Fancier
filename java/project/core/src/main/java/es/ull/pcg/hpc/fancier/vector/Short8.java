...
public class Short8 {
  ...
  public void even(Short4 result) {
    result.x = x;
    result.y = z;
    result.z = s[0];
    result.w = s[2];
  ...
  public void asShort4(Short4 result) {
    result.x = x;
    result.y = y;
    result.z = z;
    result.w = w;
  ...
  public static void isEqual(Short8 a, Short8 b, Int8 result) {
  ...
  public static void isNotEqual(Short8 a, Short8 b, Int8 result) {
    result.x = a.x != b.x? 1 : 0;
    result.y = a.y != b.y? 1 : 0;
    result.z = a.z != b.z? 1 : 0;
    result.w = a.w != b.w? 1 : 0;
  ...
  public static void isGreater(Short8 a, Short8 b, Int8 result) {
    result.x = a.x > b.x? 1 : 0;
    result.y = a.y > b.y? 1 : 0;
    result.z = a.z > b.z? 1 : 0;
    result.w = a.w > b.w? 1 : 0;
  ...
  public static void isGreaterEqual(Short8 a, Short8 b, Int8 result) {
    result.x = a.x >= b.x? 1 : 0;
    result.y = a.y >= b.y? 1 : 0;
    result.z = a.z >= b.z? 1 : 0;
    result.w = a.w >= b.w? 1 : 0;
  ...
  public static void isLess(Short8 a, Short8 b, Int8 result) {
    result.x = a.x < b.x? 1 : 0;
    result.y = a.y < b.y? 1 : 0;
    result.z = a.z < b.z? 1 : 0;
    result.w = a.w < b.w? 1 : 0;
  ...
  public static void isLessEqual(Short8 a, Short8 b, Int8 result) {
    result.x = a.x <= b.x? 1 : 0;
    result.y = a.y <= b.y? 1 : 0;
    result.z = a.z <= b.z? 1 : 0;
    result.w = a.w <= b.w? 1 : 0;
  ...
  public static void select(Short8 a, Short8 b, Int8 c, Short8 result) {
  ...
  public static void neg(Short8 a, Short8 result) {
    result.x = (short)(-a.x);
    result.y = (short)(-a.y);
    result.z = (short)(-a.z);
    result.w = (short)(-a.w);
    result.s[0] = (short)(-a.s[0]);
    result.s[1] = (short)(-a.s[1]);
    result.s[2] = (short)(-a.s[2]);
  ...
  public static void add(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x + b.x);
    result.y = (short)(a.y + b.y);
    result.z = (short)(a.z + b.z);
    result.w = (short)(a.w + b.w);
    result.s[0] = (short)(a.s[0] + b.s[0]);
    result.s[1] = (short)(a.s[1] + b.s[1]);
    result.s[2] = (short)(a.s[2] + b.s[2]);
  ...
  public static void sub(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x - b.x);
    result.y = (short)(a.y - b.y);
    result.z = (short)(a.z - b.z);
    result.w = (short)(a.w - b.w);
  ...
  public static void mul(Short8 a, Double8 b, Double8 result) {
  ...
  public static void mul(Short8 a, double k, Double8 result) {
  ...
  public static void mul(Short8 a, Float8 b, Float8 result) {
  ...
  public static void mul(Short8 a, float k, Float8 result) {
  ...
  public static void mul(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x * b.x);
    result.y = (short)(a.y * b.y);
    result.z = (short)(a.z * b.z);
    result.w = (short)(a.w * b.w);
  ...
  public static void mul(Short8 a, short k, Short8 result) {
    result.x = (short)(a.x * k);
    result.y = (short)(a.y * k);
    result.z = (short)(a.z * k);
    result.w = (short)(a.w * k);
    result.s[0] = (short)(a.s[0] * k);
    result.s[1] = (short)(a.s[1] * k);
    result.s[2] = (short)(a.s[2] * k);
  ...
  public static void div(Short8 a, Double8 b, Double8 result) {
    result.x = (double)(a.x / b.x);
    result.y = (double)(a.y / b.y);
    result.z = (double)(a.z / b.z);
    result.w = (double)(a.w / b.w);
  ...
  public static void div(Short8 a, double k, Double8 result) {
    result.x = (double)(a.x / k);
    result.y = (double)(a.y / k);
    result.z = (double)(a.z / k);
    result.w = (double)(a.w / k);
  ...
  public static void div(Short8 a, Float8 b, Float8 result) {
    result.x = (float)(a.x / b.x);
    result.y = (float)(a.y / b.y);
    result.z = (float)(a.z / b.z);
    result.w = (float)(a.w / b.w);
  ...
  public static void div(Short8 a, float k, Float8 result) {
    result.x = (float)(a.x / k);
    result.y = (float)(a.y / k);
    result.z = (float)(a.z / k);
    result.w = (float)(a.w / k);
  ...
  public static void div(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x / b.x);
    result.y = (short)(a.y / b.y);
    result.z = (short)(a.z / b.z);
    result.w = (short)(a.w / b.w);
  ...
  public static void div(Short8 a, short k, Short8 result) {
    result.x = (short)(a.x / k);
    result.y = (short)(a.y / k);
    result.z = (short)(a.z / k);
    result.w = (short)(a.w / k);
  ...
  public static void mod(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x % b.x);
    result.y = (short)(a.y % b.y);
    result.z = (short)(a.z % b.z);
    result.w = (short)(a.w % b.w);
  ...
  public static void mod(Short8 a, short k, Short8 result) {
    result.x = (short)(a.x % k);
    result.y = (short)(a.y % k);
    result.z = (short)(a.z % k);
    result.w = (short)(a.w % k);
  ...
  public static void bitAnd(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x & b.x);
    result.y = (short)(a.y & b.y);
    result.z = (short)(a.z & b.z);
    result.w = (short)(a.w & b.w);
  ...
  public static void bitOr(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x | b.x);
    result.y = (short)(a.y | b.y);
    result.z = (short)(a.z | b.z);
    result.w = (short)(a.w | b.w);
  ...
  public static void bitXor(Short8 a, Short8 b, Short8 result) {
    result.x = (short)(a.x ^ b.x);
    result.y = (short)(a.y ^ b.y);
    result.z = (short)(a.z ^ b.z);
    result.w = (short)(a.w ^ b.w);
  ...
  public static void bitNot(Short8 a, Short8 result) {
    result.x = (short)(~a.x);
    result.y = (short)(~a.y);
    result.z = (short)(~a.z);
    result.w = (short)(~a.w);
  ...
  public static void abs(Short8 a, Short8 result) {
  ...
  public static void clamp(Short8 a, Short8 b, Short8 c, Short8 result) {
  ...
  public static void max(Short8 a, Short8 b, Short8 result) {
  ...
  public static void maxMag(Short8 a, Short8 b, Short8 result) {
  ...
  public static void min(Short8 a, Short8 b, Short8 result) {
  ...
  public static void minMag(Short8 a, Short8 b, Short8 result) {
  ...
  public static void mix(Short8 a, Short8 b, Short8 c, Short8 result) {
  ...
  public static void clamp(Short8 v, short min, short max, Short8 result) {
  ...
  public static void max(Short8 x, short y, Short8 result) {
  ...
  public static void min(Short8 x, short y, Short8 result) {
  ...
  public static void mix(Short8 x, Short8 y, short a, Short8 result) {
  ...
  public static void absDiff(Short8 a, Short8 b, Short8 result) {
  ...
  public static void addSat(Short8 a, Short8 b, Short8 result) {
  ...
  public static void clz(Short8 a, Short8 result) {
  ...
  public static void hadd(Short8 a, Short8 b, Short8 result) {
  ...
  public static void madHi(Short8 a, Short8 b, Short8 c, Short8 result) {
  ...
  public static void madSat(Short8 a, Short8 b, Short8 c, Short8 result) {
  ...
  public static void mulHi(Short8 a, Short8 b, Short8 result) {
  ...
  public static void rhadd(Short8 a, Short8 b, Short8 result) {
  ...
  public static void rotate(Short8 a, Short8 b, Short8 result) {
  ...
  public static void subSat(Short8 a, Short8 b, Short8 result) {
