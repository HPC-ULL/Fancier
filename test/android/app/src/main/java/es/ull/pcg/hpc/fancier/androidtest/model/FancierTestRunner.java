...
public class FancierTestRunner {
  ...
  public enum Tests {
    ...
    TEST_JAVA_GRAYSCALE(JavaImageFilter.Version.BITMAP, ImageFilters.GRAYSCALE),
    TEST_JAVA_BLUR(JavaImageFilter.Version.BITMAP, ImageFilters.BLUR),
    TEST_JAVA_CONVOLVE3(JavaImageFilter.Version.BITMAP, ImageFilters.CONVOLVE3),
    TEST_JAVA_CONVOLVE5(JavaImageFilter.Version.BITMAP, ImageFilters.CONVOLVE5),
    TEST_JAVA_BILATERAL(JavaImageFilter.Version.BITMAP, ImageFilters.BILATERAL),
    TEST_JAVA_MEDIAN(JavaImageFilter.Version.BITMAP, ImageFilters.MEDIAN),
    TEST_JAVA_CONTRAST(JavaImageFilter.Version.BITMAP, ImageFilters.CONTRAST),
    TEST_JAVA_FISHEYE(JavaImageFilter.Version.BITMAP, ImageFilters.FISHEYE),
    TEST_JAVA_LEVELS(JavaImageFilter.Version.BITMAP, ImageFilters.LEVELS),
    TEST_JAVA_POSTERIZE(JavaImageFilter.Version.BITMAP, ImageFilters.POSTERIZE),
