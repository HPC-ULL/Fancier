...
FANCIER_API int fcARGBImage_initPixels(fcARGBImage* self, jint* pixels, int width, int height);
...
#ifdef __ANDROID__
FANCIER_API int fcARGBImage_initBitmap(fcARGBImage* self, AndroidBitmapInfo info,
                                       const void* pixels);
#endif  // __ANDROID__
