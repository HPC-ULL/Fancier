...
FANCIER_API fc${type|c}${vlen} fc${type|c}${vlen}Array_getElement (fc${type|c}${vlen}Array* self, int i, int* err);
FANCIER_API int fc${type|c}${vlen}Array_setElement (fc${type|c}${vlen}Array* self, int i, fc${type|c}${vlen} x);
