...
FANCIER_API j${type|l} fc${type|c}Array_getElement (fc${type|c}Array* self, int i, int* err);
FANCIER_API int fc${type|c}Array_setElement (fc${type|c}Array* self, int i, j${type|l} x);
