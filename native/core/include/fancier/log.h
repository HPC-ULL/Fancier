...
#define FC_LOGVERBOSE(_str)\
  __fcinternal_log(FC_LOG_VERBOSE, FC_LOG_TAG, _str)

/// Logs a string \a _str with priority \c DEBUG.
#define FC_LOGDEBUG(_str)\
  __fcinternal_log(FC_LOG_DEBUG, FC_LOG_TAG, _str)

/// Logs a string \a _str with priority \c INFO.
#define FC_LOGINFO(_str)\
  __fcinternal_log(FC_LOG_INFO, FC_LOG_TAG, _str)

/// Logs a string \a _str with priority \c WARN.
#define FC_LOGWARN(_str)\
  __fcinternal_log(FC_LOG_WARN, FC_LOG_TAG, _str)

/// Logs a string \a _str with priority \c ERROR.
#define FC_LOGERROR(_str)\
  __fcinternal_log(FC_LOG_ERROR, FC_LOG_TAG, _str)

/// Logs a string \a _str with priority \c FATAL.
#define FC_LOGFATAL(_str)\
  __fcinternal_log(FC_LOG_FATAL, FC_LOG_TAG, _str)
