...
FANCIER_API jbyte fcByteArray_getElement (fcByteArray* self, int i, int* err);
FANCIER_API int fcByteArray_setElement (fcByteArray* self, int i, jbyte x);
...
FANCIER_API jshort fcShortArray_getElement (fcShortArray* self, int i, int* err);
FANCIER_API int fcShortArray_setElement (fcShortArray* self, int i, jshort x);
...
FANCIER_API jint fcIntArray_getElement (fcIntArray* self, int i, int* err);
FANCIER_API int fcIntArray_setElement (fcIntArray* self, int i, jint x);
...
FANCIER_API jlong fcLongArray_getElement (fcLongArray* self, int i, int* err);
FANCIER_API int fcLongArray_setElement (fcLongArray* self, int i, jlong x);
...
FANCIER_API jfloat fcFloatArray_getElement (fcFloatArray* self, int i, int* err);
FANCIER_API int fcFloatArray_setElement (fcFloatArray* self, int i, jfloat x);
...
FANCIER_API jdouble fcDoubleArray_getElement (fcDoubleArray* self, int i, int* err);
FANCIER_API int fcDoubleArray_setElement (fcDoubleArray* self, int i, jdouble x);
